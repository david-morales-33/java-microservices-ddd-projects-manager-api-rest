package com.microservice.administrative.shared.infrastructure;

import com.microservice.administrative.shared.domain.bus.command.Command;
import com.microservice.administrative.shared.domain.bus.command.CommandBus;
import com.microservice.administrative.shared.domain.bus.event.DomainEvent;
import com.microservice.administrative.shared.domain.bus.event.EventBus;
import com.microservice.administrative.shared.domain.bus.query.Query;
import com.microservice.administrative.shared.domain.bus.query.QueryBus;
